# Generated by Django 2.0.6 on 2018-06-17 10:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='supplier.Cycle')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='cart',
            name='items',
            field=models.ManyToManyField(through='cart.CartItem', to='supplier.Cycle'),
        ),
        migrations.AddField(
            model_name='cart',
            name='user',
